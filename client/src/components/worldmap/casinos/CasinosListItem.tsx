...
type CasinosListItemProps = {
  casino: CasinoInterface | undefined;
  order: number;
  coords: UIPosition | undefined;
  onFeed?: () => void;
};

export const CasinosListItem = ({
  casino,
  order,
  coords,
  onFeed = undefined,
}: CasinosListItemProps) => {
  ...
  return (
    <div className="flex flex-col p-2 border rounded-md border-gray-gold text-xxs text-gray-gold">
      ...
      <div className="flex flex-col w-full mt-3">
        <ProgressBar rounded progress={casino?.progress || 0} className="bg-white" />
